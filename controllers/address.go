...
func AddAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if size < 2 {
			...
			c.IndentedJSON(400, "Not Allowed More than 2 addresses")
			println("Already 2 addresses")
			return
		}
		defer cancel()
		c.JSON(http.StatusCreated, "Successfully Added Address!!!")
		ctx.Done()
	}
}
...
func DeleteAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		ctx.Done()
		c.IndentedJSON(200, "Successfully Deleted Both Addresses")
	}
}
